...
(function (exports) {
    ...
    exports.simplyCountdown = (elt, args) => {
        ...
        //Aportación 1 LOBO ESTEPARIO
        //Calculamos el número de veces que han pasado 10 días desde la fecha de inicio hasta la fecha actual
        //lo guardamos en la variable secuenciaAcumulados
        let fechaActual=Math.round(+new Date()/1000);
		let fechaInicio= Math.round(targetTmpDate.getTime()/1000);
		let secuenciaAcumulados=Math.round((fechaActual-fechaInicio)/864000)+1;
		//console.log(secuenciaAcumulados);
        ...
        let runCountdown = (theCountdown) => {
            ...
            refresh = function () {
                ...
                if (secondsLeft > 0) {
                    ...
                    minutes = 0;
                    seconds = 0;
                   //Aportación 2 LOBO ESTEPARIO
                   //Quitamos el clearinterval pq ya no nos sirve. No interesa que termine pq lo vamos a reiniciar
                   //window.clearInterval(interval);
                   //pasando del callback onEnd
                   //parameters.onEnd();  
                   //este else es el que se activa cuando el contador llega a 0 usando los parámetros iniciales
                   //cuando se cumpla el else añadimos 10 días en segundos a la variable secondsLeft multiplicado por
                   //el numero de ciclos de 10 días que hemos obtenido en secuenciaAcumulados
                  secondsLeft += 864000*secuenciaAcumulados;
                  //llamamos a la función updateDisplayDate que es la q activa la cuenta atrás
                   updateDisplayDate();                 
                ...
                if (parameters.plural) {
                    ...
                    dayWord = parameters.words.days.singular;/* global Symbol */
